// WMass: private copy of the CMSSW_10_6_26 PUPPI code (interface/PuppiAlgo.h) for the PV-robust
...
#ifndef WMASS_PUPPI106_CommonTools_PileupAlgos_PuppiAlgo_h
#define WMASS_PUPPI106_CommonTools_PileupAlgos_PuppiAlgo_h
