...
# low-pT Lambda pion daughters are not rejected at the `plimit` exit. About
# 70% of CVH propagation failures came from this cut; lowering it to 0.05
# GeV recovers them while staying above the regime where Geant4 step-finding
# becomes unreliable.
