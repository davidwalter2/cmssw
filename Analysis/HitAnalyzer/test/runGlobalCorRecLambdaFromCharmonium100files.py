## Same as runGlobalCorRecLambdaFromAlca.py but pointing at the Charmonium-based
...
process.source = cms.Source(
    ...
    fileNames=cms.untracked.vstring(
        'file:/ceph/submit/data/user/d/david_w/ZMass/alcareco/260506_AllResonances_charmonium_100files/merged/TkAlLambdaToProtonPi.root'
    )
)
