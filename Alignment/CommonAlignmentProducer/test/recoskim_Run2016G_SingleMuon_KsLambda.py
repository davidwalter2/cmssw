...
# Lower the V0Producer track-pT cut from the default 0.35 GeV to 0.10 GeV so
# the ALCARECO captures all V0 candidates with daughters above 0.10 GeV. This
# is a test-script-only override -- it modifies the single generalV0Candidates
# instance in this job, which also affects the V0 collection written to the
# AOD output. Production ALCARECO submissions should leave this at the default.
process.generalV0Candidates.tkPtCut = 0.1
